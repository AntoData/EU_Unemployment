...
Data obtained from http://appsso.eurostat.ec.europa.eu/nui/show.do?dataset=tps00203&lang=en
official European Union data source
File ./tps00203.tsv was downloaded from there
'''
#folium to build the map where we will display our data
import folium
